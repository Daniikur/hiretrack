    ...
    <div className="p-6 md:p-12 max-w-7xl">
      <div className="flex items-end justify-between mb-10 fade-up">
        <div>
          ...
          <h1
            className="font-display text-5xl md:text-6xl font-black tracking-tighter uppercase mt-2"
        ...
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
            ...
            <div className="lg:col-span-2 glass p-8">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <div className="font-display text-2xl font-black uppercase mt-1">
                    Last 8 weeks
                  </div>
                </div>

                <TrendingUp
                  className="w-5 h-5 text-[#FF3823]"
                  strokeWidth={1.5}
                />
              </div>
            ...
            <div className="glass p-8 flex flex-col justify-between">
              <div>
                <Target
                  className="w-5 h-5 text-[#FF3823] mb-4"
                  strokeWidth={1.5}
                />
                ...
                <div
                  className="font-display text-6xl font-black tracking-tighter mt-2"
          ...
          <div className="glass p-8">
            ...
            {recent.length === 0 ? (
              <div className="text-center py-12 border border-dashed border-white/10">
                <FileText
                  className="w-8 h-8 text-white/20 mx-auto mb-3"
                  strokeWidth={1.5}
                />
                ...
                <Link
                  to="/app/applications"
                  data-testid="empty-add-cta"
                  className="text-xs text-[#FF3823] hover:underline"
                >
                  + Add your first one
                </Link>
              </div>
